...
def runPrediction():
    ...
    #Bock data
    filerawtrain = "/home/akreshuk/data/context/TEM_raw/bock_training_5_28_slices.h5"
    filerawtest = "/home/akreshuk/data/context/TEM_raw/bock_testing_51_81_slices.h5"
    filelabels = "/home/akreshuk/data/context/TEM_labels/bock_training_5_28_slices.h5"
    resdir = "/home/akreshuk/data/context/TEM_results/"
    resproject = "bock_testing_1024_2048_51_83_all_iter0.ilp"
    tempfile = "/home/akreshuk/data/context/bock_1024_2048_51_83_all_iter0.h5"
    ...
    opMulti = createImageFeatureOperators(g, slicer, sigmas)
    opMultiTest = createImageFeatureOperators(g, slicertest, sigmas)
    ...
    featurecacheTest.inputs["innerBlockShape"].setValue((8,8,8,180))
    featurecacheTest.inputs["outerBlockShape"].setValue((64,64,64,180))
...
def createImageFeatureOperators(g, slicer, sigmas):
    opMulti = operators.Op50ToMulti(g)
    count = 0
    for sigma in sigmas:
        #Gaussian smoothing
