...
def Train(tempfile, tempfilenew, rffile, opernames, radii, radii_anis, use3d):
    ...
    featurecachetrain.inputs["innerBlockShape"].setValue((64,64,30,500))
    featurecachetrain.inputs["outerBlockShape"].setValue((128,128,30,500))
    ...
    predictioncache.inputs["innerBlockShape"].setValue((128, 128, 30, 5))
    predictioncache.inputs["outerBlockShape"].setValue((128, 128, 30, 5))
    predictioncache.inputs["Input"].connect(opPredict.outputs["PMaps"])
