...
def playback_events(player):
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(215, 0), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(215, 0), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(391, 2), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(391, 2), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    player.post_event( 'MainWindow.QMenuBar_0', event , 2.21219 )

    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonPress, PyQt5.QtCore.QPoint(75, 11), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(386, 119), (Qt.LeftButton), (Qt.LeftButton), Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonRelease, PyQt5.QtCore.QPoint(75, 11), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(386, 119), (Qt.LeftButton), Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(17, 8), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(745, 520), Qt.NoButton, (Qt.LeftButton), Qt.NoModifier)
    player.post_event( 'MainWindow.QFileDialog.buttonBox.QPushButton_0', event , 3.323605 )

    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonPress, PyQt5.QtCore.QPoint(17, 8), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(745, 520), (Qt.LeftButton), Qt.NoButton, Qt.NoModifier)
    player.post_event( 'MainWindow.QFileDialog.buttonBox.QPushButton_0', event , 3.37243 )

    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonRelease, PyQt5.QtCore.QPoint(17, 8), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(745, 520), (Qt.LeftButton), Qt.NoButton, Qt.NoModifier)
    player.post_event( 'MainWindow.QFileDialog.buttonBox.QPushButton_0', event , 3.37243 )
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(445, 1), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(445, 1), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    player.post_event( 'MainWindow.QMenuBar_0', event , 5.021792 )

    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(73, 11), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(395, 70), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonPress, PyQt5.QtCore.QPoint(48, 13), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(370, 97), (Qt.LeftButton), (Qt.LeftButton), Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonRelease, PyQt5.QtCore.QPoint(48, -13), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(370, 97), (Qt.LeftButton), Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(48, 1), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(370, 111), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(47, 4), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(369, 114), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(46, 6), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(368, 116), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(45, 9), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(367, 119), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(45, 10), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(367, 120), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonPress, PyQt5.QtCore.QPoint(45, 10), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(367, 120), (Qt.LeftButton), (Qt.LeftButton), Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonRelease, PyQt5.QtCore.QPoint(45, 10), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(367, 120), (Qt.LeftButton), Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(45, 38), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(367, 120), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(429, 4), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(429, 4), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    player.post_event( 'MainWindow.QMenuBar_0', event , 26.830528 )

    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(108, 2), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(448, 61), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(113, 17), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(453, 76), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(187, 27), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(527, 109), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(194, 18), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(534, 100), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(195, 16), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(535, 98), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonPress, PyQt5.QtCore.QPoint(195, 16), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(535, 98), (Qt.RightButton), (Qt.RightButton), Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QContextMenuEvent(0, PyQt5.QtCore.QPoint(195, 16), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(535, 98), Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonRelease, PyQt5.QtCore.QPoint(), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(535, 98), (Qt.RightButton), Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(535, 98), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(2, 0), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(537, 98), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(9, 4), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(544, 102), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(13, 4), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(548, 102), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(14, 4), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(549, 102), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(16, 6), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(551, 104), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(18, 10), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(553, 108), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonPress, PyQt5.QtCore.QPoint(18, 10), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(553, 108), (Qt.LeftButton), (Qt.LeftButton), Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonRelease, PyQt5.QtCore.QPoint(18, 10), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(553, 108), (Qt.LeftButton), Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(3, 2), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(266, 156), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(24, 9), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(287, 163), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(22, 10), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(285, 164), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(18, 10), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(281, 164), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonPress, PyQt5.QtCore.QPoint(18, 10), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(281, 164), (Qt.LeftButton), (Qt.LeftButton), Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonRelease, PyQt5.QtCore.QPoint(18, 10), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(281, 164), (Qt.LeftButton), Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonDblClick, PyQt5.QtCore.QPoint(18, 10), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(281, 164), (Qt.LeftButton), (Qt.LeftButton), Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(19, 10), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(282, 164), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(29, 11), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(292, 165), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(38, 16), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(301, 170), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonPress, PyQt5.QtCore.QPoint(24, 5), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(843, 643), (Qt.LeftButton), (Qt.LeftButton), Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseButtonRelease, PyQt5.QtCore.QPoint(24, 5), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(843, 643), (Qt.LeftButton), Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(523, 502), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(843, 643), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(521, 502), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(841, 643), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(414, 469), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(734, 610), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
    ...
    event = PyQt5.QtGui.QMouseEvent(QEvent.MouseMove, PyQt5.QtCore.QPoint(169, 340), mainwin.mapToGlobal( QPoint(0,0) ) + PyQt5.QtCore.QPoint(489, 481), Qt.NoButton, Qt.NoButton, Qt.NoModifier)
