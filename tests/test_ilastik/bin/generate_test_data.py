...
def generate_random_data(output_dir):
    ...
    gen_rand_npy(
        shape=(1, 100, 100, 20, 1),
        dtype=numpy.uint8,
        drange=(0, 255),
        output_dir=output_dir,
        filename="rand_uint8_5d.npy",
    )
    gen_rand_npy(
        shape=(100, 100, 20, 1), dtype=numpy.uint8, drange=(0, 255), output_dir=output_dir, filename="rand_uint8_4d.npy"
    )
    gen_rand_npy(
        shape=(100, 100, 20), dtype=numpy.uint8, drange=(0, 255), output_dir=output_dir, filename="rand_uint8_3d.npy"
    )
    gen_rand_npy(
        shape=(100, 100, 20), dtype=numpy.uint8, drange=(0, 255), output_dir=output_dir, filename="rand_uint8_3d.npy"
    )
    gen_rand_npy(
        shape=(100, 100), dtype=numpy.uint8, drange=(0, 255), output_dir=output_dir, filename="rand_uint8_2d.npy"
    )
