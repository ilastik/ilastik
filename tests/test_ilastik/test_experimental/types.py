...
class TestData(str, enum.Enum):
    DATA_1_CHANNEL: str = ("Data_1channel.png", "yx")
    DATA_3_CHANNEL: str = ("Data_3channel.png", "yxc")
    DATA_1_CHANNEL_3D: str = ("Data_3D.npy", "zyxc")
...
class ApiTestDataLookup:
    ...
    def find_dataset(self, file_name: TestData) -> Dataset:
        ...
        return Dataset(path, file_name.axes)
