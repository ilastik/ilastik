...
class TestConservationTrackingHeadless(object):
    ...
    def testCTCExport(self):
        ...
        resTrackFilename = os.path.join(
            self.ilastik_tests_file_path, "data", "inputdata", "smallVideo_CellTrackingChallenge", "res_track.txt"
        )
        ...
        for i in range(7):
            assert os.path.exists(
                os.path.join(
                    ...
                    "data",
                    "inputdata",
                    "smallVideo_CellTrackingChallenge",
                    f"mask00{i}.tif",
                )
            ), f"Missing frame {i}"
        ...
        imagePath = os.path.join(
            self.ilastik_tests_file_path, "data", "inputdata", "smallVideo_CellTrackingChallenge", "mask000.tif"
        )
        ...
        # cleanup
        shutil.rmtree(
            os.path.join(self.ilastik_tests_file_path, "data", "inputdata", "smallVideo_CellTrackingChallenge")
        )
    ...
    def testHDF5Export(self):
        ...
        for i in range(7):
            assert os.path.exists(
                os.path.join(
                    self.ilastik_tests_file_path, "data", "inputdata", "smallVideo_H5-Event-Sequence", f"0000{i}.h5"
                )
            ), f"Missing frame {i}"
    ...
    def testJsonExport(self):
        ...
        # check output files exist
        files = [
            os.path.join(self.ilastik_tests_file_path, "data", "inputdata", "smallVideo_JSON_graph.json"),
