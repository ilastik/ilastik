...
@pytest.mark.parametrize(
    ...
    [
        ...
        (f"/pix_res/3d_t.tiff", {"x": (3, "mm"), "y": (5, "mm"), "z": (7, "mm"), "t": (3, "sec")}),
        (f"/pix_res/5d.tiff", {"x": (17, "cm"), "y": (13, "pm"), "z": (8, "mm"), "c": (), "t": (3, "sec")}),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (f"/pix_res/2d.tif", {'x': (2, "cm"), 'y': (7, "nm")}),
        (f"/pix_res/3d.tiff", {'x': (11, "cm"), 'y': (6, "mm"), 'z': (2, "pm")}),
        (f"/pix_res/2d_t.tiff", {'x': (50, "μm"), 'y': (3, "pm"), 't': (3, "sec")}),
        (f"/pix_res/3d_t.tiff", {'x': (3, "mm"), 'y': (5,"mm"), 'z': (7,"mm"), 't': (3, "sec")}),
        (f"/pix_res/3d_c.tiff", {'x': (2, "μm"), 'y': (11,"nm"), 'z': (13,"cm"), 'c': ()}),
        (f"/pix_res/5d.tiff", {'x': (17,"cm"), 'y': (13,"pm"), 'z': (8,"mm"), 'c': (), 't': (3, "sec")})
    ],
)
"""
