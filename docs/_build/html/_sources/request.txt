...
The request framework provides infrastructure for scheduling user-defined tasks.  This dependency diagram shows how user-defined workloads depend on the parts of the request system.
