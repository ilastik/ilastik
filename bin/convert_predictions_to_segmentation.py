...
def convert_predictions_to_segmentation( input_path, parsed_export_args ):
    """
...
if __name__ == "__main__":
    import sys
    import argparse
    #sys.argv += "/tmp/example_slice.h5/data --export_drange=(0,255) --output_format=png --pipeline_result_drange=(1,2)".split()
    ...
    sys.exit( convert_predictions_to_segmentation( parsed_args.input_path, 
                                                   parsed_args ) )
