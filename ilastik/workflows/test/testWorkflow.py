...
from ilastik.applets.channelSelection.channelSelectionApplet import ChannelSelectionApplet
...
class TestWorkflow(Workflow):
    workflowName = "ChannelSelection ['Raw Data', ' Probabilities']"
    workflowDescription = "A test worklfow for selection"
    ...
    def __init__(self, shell, headless, workflow_cmdline_args, project_creation_workflow, *args, **kwargs):
        ...
        # -- ChannelSelection applet
        #
        # ( workflow=self, guiName='', projectFileGroupName='' )
        self.channelSelectionApplet = ChannelSelectionApplet(self, "Channel", "ChannelSelection")
        ...
        self._applets.append(self.channelSelectionApplet)
    ...
    def connectLane(self, laneIndex):
        ...
        opChannelSelection      = self.channelSelectionApplet.topLevelOperator.getLane(laneIndex)
        ...
        #opDataExport.Inputs[0].connect( opChannelSelection.Superpixels )
        opDataExport.Inputs[0].connect( opChannelSelection.Output )
    ...
    def handleAppletStateUpdateRequested(self):
        ...
        opDataSelection = self.dataSelectionApplet.topLevelOperator
        opDataExport = self.dataExportApplet.topLevelOperator
        opChannelSelection = self.channelSelectionApplet.topLevelOperator
        ...
        self._shell.setAppletEnabled( self.channelSelectionApplet,\
                not batch_processing_busy and input_ready )
        self._shell.setAppletEnabled( self.dataExportApplet,\
                not batch_processing_busy and input_ready and opChannelSelection.Superpixels.ready())
        ...
        busy |= self.channelSelectionApplet.busy
