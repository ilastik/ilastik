...
class ObjectClassificationWorkflow(Workflow):
    ...
    def connectLane(self, laneIndex):
        ...
        opDataExport.Inputs[EXPORT_SELECTION_BLOCKWISE_PREDICTIONS].connect(
            opBlockwiseObjectClassification.PredictionImage
        )
        opDataExport.Inputs[EXPORT_SELECTION_BLOCKWISE_PROBABILITIES].connect(
...
class ObjectClassificationWorkflowPixel(ObjectClassificationWorkflow):
    ...
    def setupInputs(self):
        ...
        self.dataSelectionApplet = DataSelectionApplet(
            self, "Input Data", "Input Data", batchDataGui=False, forceAxisOrder=None, instructionText=data_instructions
        )
