...
#                                                         slots=slots)
class DivisionFeatureExtractionSerializer(ObjectExtractionSerializer):
    def __init__(self, operator, projectFileGroupName):
        super(DivisionFeatureExtractionSerializer, self).__init__(operator, projectFileGroupName)