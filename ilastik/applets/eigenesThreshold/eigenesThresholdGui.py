...
from volumina.widgets.eigenesThresholdWidget import EigenesThresholdWidget
from ilastik.applets.layerViewer.layerViewerGui import LayerViewerGui

class EigenesThresholdGui(LayerViewerGui):
    """
    ...
    def __init__(self, parentApplet, topLevelOperatorView):
        ...
        super(EigenesThresholdGui, self).__init__(parentApplet, self.topLevelOperatorView)
    ...
    def initAppletDrawerUi(self):
        ...
        self.eigenesThresholdWidget = EigenesThresholdWidget(self)
        self.eigenesThresholdWidget.valueChanged.connect( self.apply_gui_settings_to_operator )

        # Add widget to a layout
        layout = QVBoxLayout()
        layout.setSpacing(0)
        layout.addWidget( self.eigenesThresholdWidget )
    ...
    def apply_operator_settings_to_gui(self):
        ...
        self.eigenesThresholdWidget.setValue(minValue, maxValue)
