...
vigra_features = ['Count', 'RegionCenter', 'Mean', 'Variance', 'RegionRadii', 'Maximum', 'Minimum', 'Quantiles', 'Skewness', 'Sum', 'Coord<Principal<Kurtosis>>', 'Coord<Principal<Skewness>>', 'Kurtosis']
