...
class CNNPixelClassificationApplet(PixelClassificationApplet):
    ...
    def __init__(self, workflow, projectFileGroupName):
        ...
        self._serializableItems = [CNNPixelClassificationSerializer(self._topLevelOperator, projectFileGroupName)]
    ...
    def singleLaneGuiClass(self):
        from .cnnPixelClassificationGui import CNNPixelClassificationGui
        return CNNPixelClassificationGui
