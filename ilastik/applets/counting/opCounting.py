...
class OpCounting(Operator):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.opLabelPipeline = OpMultiLaneWrapper(
            OpLabelPipeline, parent=self, broadcastingSlotNames=["DeleteLabel"]  # Labels are never deleted...
        )
    ...
    def _checkConstraints(self, laneIndex):
        ...
        if "z" in thisLaneTaggedShape:
            raise DatasetConstraintError(
                ...
                "Your new image has {} z dimension".format(thisLaneTaggedShape["z"]),
            )
        ...
        if "t" in thisLaneTaggedShape:
            raise DatasetConstraintError(
                ...
                "Your new image has {} t dimension".format(thisLaneTaggedShape["t"]),
            )
            # Find a different lane and use it for comparison
