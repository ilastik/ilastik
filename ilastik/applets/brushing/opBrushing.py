...
class OpBrushingTopLevel( Operator ):
    """
    Top-level operator for the brushingApplet base class.
    Provides all the slots needed by the brushing GUI, but any operator that provides the necessary slots can also be used with the BrushingGui.
    """
    name = "OpBrushingTopLevel"
    ...
    def __init__(self, blockDims = None, *args, **kwargs):
        super( OpBrushingTopLevel, self ).__init__( *args, **kwargs )

        # Use a wrapper to create a brushing operator for each image lane
        self.opLabelLane = OpMultiLaneWrapper( OpBrushingSingleLane, operator_kwargs={'blockDims' : blockDims}, parent=self )
...
class OpBrushingSingleLane( Operator ):
    """
    This is a single-lane operator that can be used with the brushing applet gui.
    ...
    def __init__(self, blockDims = None, *args, **kwargs):
        ...
        """
        super(OpBrushingSingleLane, self).__init__( *args, **kwargs )
    ...
    def cleanUp(self):
        ...
        super( OpBrushingSingleLane, self ).cleanUp()
