...
def import_brushing_layer(labelLayer, brushingSlots, parent_widget=None):
    """
    Prompt the user for layer import settings, and perform the layer import.
    :param labelLayer: The top label layer source
    :param brushingSlots: An instance of BrushingGui.BrushingSlots
    :param parent_widget: The Qt GUI parent object
    """
    writeSeeds = brushingSlots.labelInput
    ...
    recentlyImported = PreferencesManager().get('brushing', 'recently imported')
    ...
    PreferencesManager().set('brushing', 'recently imported', fileNames[0])
    ...
    try:
        ...
        # Transpose the axes for assignment to the brushing operator.
        ...
        maxLabels = len(brushingSlots.labelNames.value)
        ...
        settingsDlg = LabelImportOptionsDlg( parent_widget,
                                             ...
                                             brushingSlots.labelInput, labelInfo )
        ...
        if labelMapping:
            # There are other ways to do a rebrushing (e.g skimage.segmentation.relabel_sequential)
