...
class DeviationFromMeanSerializer(AppletSerializer):
    ...
    def __init__(self, operator, projectFileGroupName):
        slots = [SerialSlot(operator.ScalingFactor, selfdepends=True), SerialSlot(operator.Offset, selfdepends=True)]

        super(DeviationFromMeanSerializer, self).__init__(projectFileGroupName, slots=slots)
