...
class DomainAdaptationGui(LabelingGui):
    ...
    def stopAndCleanUp(self):
        ...
        super(DomainAdaptationGui, self).stopAndCleanUp()
    ...
    def __init__(self, parentApplet, topLevelOperatorView, labelingDrawerUiPath=None):
        ...
        # Base class init
        super(DomainAdaptationGui, self).__init__(parentApplet, labelSlots, topLevelOperatorView, labelingDrawerUiPath)
    ...
    def setupLayers(self):
        ...
        layers = super(DomainAdaptationGui, self).setupLayers()
...
#                self.labelingDrawerUi.suggestFeaturesButton.setEnabled(False)
    ...
    def _onLabelRemoved(self, parent, start, end):
        ...
        super(DomainAdaptationGui, self)._onLabelRemoved(parent, start, end)
    ...
    def getNextLabelName(self):
        return self._getNext(self.topLevelOperatorView.LabelNames,
                             super(DomainAdaptationGui, self).getNextLabelName)

    def getNextLabelColor(self):
        return self._getNext(
            self.topLevelOperatorView.LabelColors,
            super(DomainAdaptationGui, self).getNextLabelColor,
            lambda x: QColor(*x)
        )
    ...
    def getNextPmapColor(self):
        return self._getNext(
            ...
            super(DomainAdaptationGui, self).getNextPmapColor,
            lambda x: QColor(*x)
        )

    def onLabelNameChange(dself):
        self._onLabelChanged(super(DomainAdaptationGui, self).onLabelNameChanged,
                             lambda l: l.name,
                             self.topLevelOperatorView.LabelNames)

    def onLabelColorChanged(self):
        self._onLabelChanged(super(DomainAdaptationGui, self).onLabelColorChanged,
    ...
    def onPmapColorChanged(self):
        self._onLabelChanged(super(DomainAdaptationGui, self).onPmapColorChanged,
