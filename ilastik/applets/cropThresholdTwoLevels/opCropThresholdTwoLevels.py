...
from ilastik.applets.cropping.opCropSelection import OpCropSelection
...
## High level operator for one/two level threshold on a crop
class OpCropThresholdTwoLevels(Operator):
    name = "OpCropThresholdTwoLevels"
    ...
    def __init__(self, *args, **kwargs):
        super(OpCropThresholdTwoLevels, self).__init__(*args, **kwargs)
        ...
        self.opThreshold1 = _OpCropThresholdOneLevel(parent=self)
        ...
        self.opThreshold2 = _OpCropThresholdTwoLevels(parent=self)
        ...
        if haveGraphCut():
            self.opThreshold1GC = _OpCropThresholdOneLevel(parent=self)
        ...
        print ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>",self
        #print "=========================================OpCropThresholdTwoLevels.self",self._opCropSelection
        #print "=========================================self._opCropSelection = OpCropSelection(parent=self)--->",self._opCropSelection.Crops.value
...
class _OpCropThresholdOneLevel(Operator):
    name = "_OpCropThresholdOneLevel"
    ...
    def __init__(self, *args, **kwargs):
        super(_OpCropThresholdOneLevel, self).__init__(*args, **kwargs)
...
class _OpCropThresholdTwoLevels(Operator):
    name = "_OpCropThresholdTwoLevels"
    ...
    Crops = InputSlot(stype='dict', value=dict())
    ...
    def __init__(self, *args, **kwargs):
        super(_OpCropThresholdTwoLevels, self).__init__(*args, **kwargs)
