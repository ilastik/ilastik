...
class CropThresholdTwoLevelsGui( LayerViewerGui ):
    ...
    def stopAndCleanUp(self):
        ...
        super(CropThresholdTwoLevelsGui, self).stopAndCleanUp()
    
    def __init__(self, *args, **kwargs):
        self.__cleanup_fns = []
        super( CropThresholdTwoLevelsGui, self ).__init__(*args, **kwargs)
    ...
    def initAppletDrawerUi(self):
        ...
        self._drawer = uic.loadUi(localDir+"/cropDrawer.ui")
        ...
        self._drawer.cropSpinBox.valueChanged.connect(self._onCropSpinBoxChange)
    ...
    def _updateGuiFromOperator(self):
        ...
        #self._drawer.cropSpinBox.setValue()
    ...
    def _onCropSpinBoxChange(self):
        self._currentCrop = self._crops[self._drawer.cropSpinBox.value()]
