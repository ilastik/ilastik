                                    ...
                                    if type == None:
                                        ...
                                        for edge in list(
                                            ...
                                            if edge[0][0] == time - 1 and edge[0][1] == int(
                                                ...
                                                foundAllArcs = True
                                                hypothesesGraph._graph.edge[edge[0]][edge[1]]["value"] = int(
                                                    trackCountIntersection
                                                )
                                                break
                                        if not foundAllArcs:
                    ...
                    if (misdetectionLabel not in labels[t][source]) and t + 1 in list(labels.keys()):
                        for dest in list(labels[t + 1].keys()):
                            if misdetectionLabel not in labels[t + 1][dest]:
                                ...
                                assert (
                                    (t, source) in list(traxelgraph._graph.edge.keys())
                                    and (t + 1, dest) in list(traxelgraph._graph.edge[(t, source)].keys()),
