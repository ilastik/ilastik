...
class AppletExampleSerializer(AppletSerializer): #TODO
    def __init__(self, operator, projectFileGroupName):
        slots = [ SerialSlot(operator.ChannelSelection),
                  ...
                  SerialBlockSlot(operator.Superpixels,
                                  ...
                                  shrink_to_bb=False,
                                  compression_level=1) ]
        super(AppletExampleSerializer, self).__init__(projectFileGroupName, slots=slots, operator=operator) #TODO
