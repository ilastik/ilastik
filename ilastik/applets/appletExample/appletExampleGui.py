...
class AppletExampleGui(LayerViewerGui): #TODO
    ...
    def stopAndCleanUp(self):
        ...
        # Base class
        super( AppletExampleGui, self ).stopAndCleanUp() #TODO
    ...
    def __init__(self, parentApplet, topLevelOperatorView):
        ...
        super(AppletExampleGui, self).__init__( parentApplet, topLevelOperatorView ) #TODO
