...
class OpDataSelection(Operator):
    ...
    DatasetOut = OutputSlot(stype="object")  # Connected to self.Dataset only if no dataset constraints are violated
...
class OpDataSelectionGroup(Operator):
    ...
    DatasetGroupOut = OutputSlot(stype="object", level=1)  # Valid Dataset information
