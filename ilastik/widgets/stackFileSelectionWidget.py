...
from lazyflow.operators.ioOperators import OpStackLoader, OpStreamingHdf5SequenceReaderM, OpStreamingHdf5SequenceReaderS
    ...
    def _applyPattern(self):
        ...
        try:
            ...
            filenames.extend(
                ...
                for external, internal in zip(*OpStreamingHdf5SequenceReaderM.expandGlobStrings(h5GlobStrings))
            )
        except (
