...
from conservationNonDivTrackingWorkflow import ConservationNonDivTrackingWorkflow
...
if debug_testing:
    ...
    startShellGui( ConservationNonDivTrackingWorkflow, test )

else:
    startShellGui( ConservationNonDivTrackingWorkflow )
