...
resp = post(
    ...
    data={"scribblings.location.x": 188, "scribblings.location.y": 124, "raw_data": data_source_id},
)
annot_id = resp.json()
...
resp = post(
    "http://localhost:5000/vigra_pixel_classifier",
    data={
        "strict": "true",
...
resp = post(
    "http://localhost:5000/ng_annotation",
    data={
        "voxels.0.x": 137,
        "voxels.0.y": 112,
        "voxels.0.z": 0,
